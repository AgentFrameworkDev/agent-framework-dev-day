...
public static class HumanInTheLoopWorkflowDemo
{
    public static async Task RunAsync()
    {
        ...
        // ========================================================================
        // TODO: Build the workflow with RequestPort for human review
        //
        // Hints:
        // - Create a ChatClientAgent for drafting responses
        // - Create executors: HumanInTheLoopTicketIntakeExecutor, DraftBridgeExecutor, FinalizeExecutor
        // - Create a RequestPort: RequestPort.Create<SupervisorReviewRequest, SupervisorDecision>("SupervisorReview")
        // - Build workflow: ticketIntake -> draftAgent -> draftBridge -> supervisorReviewPort -> finalizeExecutor
        // - Use InProcessExecution.RunStreamingAsync(workflow, sampleTicket)
        // - Handle RequestInfoEvent by calling handle.SendResponseAsync(HandleSupervisorReview(evt.Request))
        //
        ...
        // ========================================================================
        throw new NotImplementedException("STEP 4: Build the Human-in-the-Loop Workflow");
    }
