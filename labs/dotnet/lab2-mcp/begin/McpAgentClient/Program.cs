...
static async Task<bool> DemoLocalDotNetMcp(IConfiguration configuration, string endpoint, string deploymentName)
{
    ...
    // ========================================================================
    // STEP 1: Create MCP client for local .NET server using STDIO transport
    // ========================================================================
    // TODO: Create a StdioClientTransport and then create an MCP client
    //
    // Hints:
    // - Create a StdioClientTransport with StdioClientTransportOptions
    //   (Name = "LocalDotNetMcpServer", Command = "dotnet", Arguments = ["run", "--project", mcpLocalProject])
    // - Use McpClient.CreateAsync(clientTransport) to create the client
    // - Don't forget 'await using' for proper disposal
    //
    ...
    // ========================================================================
    throw new NotImplementedException("STEP 1: Create MCP client for local .NET server using STDIO transport");
#if COMPLETED_STEPS
    ...
    // ========================================================================
    // STEP 4: Create IChatClient with MCP tools for function invocation
    // ========================================================================
    // TODO: Create an IChatClient that uses Azure OpenAI and supports function invocation
    //
    // Hints:
    // - Use CreateAzureOpenAIClient() to get an AzureOpenAIClient
    // - Call .GetChatClient(deploymentName) to get a ChatClient
    // - Call .AsIChatClient() to convert to IChatClient
    // - Use .AsBuilder().UseFunctionInvocation().Build() to enable function calling
    // - Create ChatOptions with Tools = [.. tools.Select(t => (AITool)t)]
    //
    ...
    // };
    // ========================================================================
    throw new NotImplementedException("STEP 4: Create IChatClient with MCP tools for function invocation");
...
static async Task<bool> DemoRemoteMcp(IConfiguration configuration, string endpoint, string deploymentName)
{
    ...
    // ========================================================================
    // STEP 5: Create MCP client for MCP Bridge using HTTP transport
    // ========================================================================
    // TODO: Create an HttpClientTransport and then create an MCP client
    //
    // Hints:
    // - Create an HttpClientTransport with HttpClientTransportOptions
    ...
    // await using var mcpClient = await McpClient.CreateAsync(clientTransport);
    // ========================================================================
    throw new NotImplementedException("STEP 5: Create MCP client for MCP Bridge using HTTP transport");
#if COMPLETED_STEPS
